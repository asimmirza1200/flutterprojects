...
class _Sugestion extends State<SuggestionList> {
  ...
  Widget build(BuildContext context) {
    // print("HAGSgasA"+widget.places.length.toString());
  ...
  Widget _sugestionTable() {
    print("HAGSgasgfgA"+( widget.places.length > 3 ? 3 : widget.places.length ).toString());

    return new ListView.builder(
        itemCount: widget.places != null ? widget.places.length > 3 ? 3 : widget
            .places.length : 0,
