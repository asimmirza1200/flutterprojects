                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Visibility(
                            visible: (widget.place != null ? (widget.place.reviewCount ?? 0) : 0) > 0,
                            child: Container(
                              margin: EdgeInsets.only(left: 6),
                              child: Text("(${widget.place != null ? (widget.place.reviewCount ?? 0) : 0} reviews)",
                                  style: TextStyle(
                                      fontFamily: GoloFont,
                                      fontSize: 15,
                                      color: Colors.white,
                          ...
                          visible: widget.place != null && widget.place.priceRange != null && widget.place.priceRange.isNotEmpty,
                          ),
                          Text(
                              widget.place != null ? (widget.place.priceRange ?? "") : "",
                              style: TextStyle(
                                  fontFamily: GoloFont,
                                  fontSize: 15,
                                  color: Colors.white,
