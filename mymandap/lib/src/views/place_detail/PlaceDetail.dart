                ...
                children: <Widget>[
                  ...
                  CupertinoButton(
                    ...
                    onPressed: () async {
                      ...
                      var found=false;
                      if(prefs.getString("bookmarklist")!=null){
                        for (var json in jsonDecode(prefs.getString("bookmarklist"))) {
                          print(json);
                          if(place.id!=Place.fromJson(json).id){
                            bookmarks.add(Place.fromJson(json));
                          }else{
                            found=true;
                          }
                        }
                      ...
                      prefs.setString("bookmarklist",jsonEncode( bookmarks));
                     // print(jsonEncode( bookmarks));
                    },
                  )
                ],
              ),
