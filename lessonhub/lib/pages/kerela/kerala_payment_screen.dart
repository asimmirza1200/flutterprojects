...
class KeralaPaymentDetail extends StatefulWidget {
  final Map arguments;
  KeralaPaymentDetail({this.arguments});

  @override
  _KeralaPaymentDetailState createState() => _KeralaPaymentDetailState();
}

class _KeralaPaymentDetailState extends State<KeralaPaymentDetail> {
                                  ...
                                  onPressed: () {
                                    AppRoutes.nextScreen(
                                      ...
                                      arguments: {
                                        ...
                                        "category":
                                            this.widget.arguments["category"] ??
                                                this
                                                    .widget
                                                    .arguments["category"]
                                                    .toString()
