...
class KeralaPlayScreen extends StatefulWidget {
  final Map arguments;
  KeralaPlayScreen({this.arguments});
  @override
  _KeralaPlayScreenState createState() => _KeralaPlayScreenState();
}

class _KeralaPlayScreenState extends State<KeralaPlayScreen> {
  int _index = 0;
  bool loading = true;
        ...
        body: FutureBuilder(
          future: this._memoizer.runOnce(() async {
            try {
              ...
              quizQuestions = this.widget.arguments["questions"];
