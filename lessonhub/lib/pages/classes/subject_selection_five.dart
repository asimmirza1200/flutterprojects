...
class SubjectSelectionFive extends StatefulWidget {
  final Color themeColor;
  final Color leftPatternColor;
  final Color leftTextColor;
  final Map arguments;
  SubjectSelectionFive({
    this.themeColor,
  ...
  @override
  _SubjectSelectionFiveState createState() => _SubjectSelectionFiveState();
}

class _SubjectSelectionFiveState extends State<SubjectSelectionFive> {
