...
class SubjectSelectionNine extends StatefulWidget {
  final Color themeColor;
  final Color leftPatternColor;
  final Color leftTextColor;
  final Map arguments;
  SubjectSelectionNine({
    this.themeColor,
  ...
  @override
  _SubjectSelectionNineState createState() => _SubjectSelectionNineState();
}

class _SubjectSelectionNineState extends State<SubjectSelectionNine> {
