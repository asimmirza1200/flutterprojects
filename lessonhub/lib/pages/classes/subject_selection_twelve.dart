...
class SubjectSelectionTwelve extends StatefulWidget {
  final Color themeColor;
  final Color leftPatternColor;
  final Color leftTextColor;
  final Map arguments;
  SubjectSelectionTwelve({
    this.themeColor,
  ...
  @override
  _SubjectSelectionTwelveState createState() => _SubjectSelectionTwelveState();
}

class _SubjectSelectionTwelveState extends State<SubjectSelectionTwelve> {
