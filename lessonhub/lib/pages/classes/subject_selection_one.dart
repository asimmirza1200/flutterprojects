...
class SubjectSelectionOne extends StatefulWidget {
  ...
  @override
  _SubjectSelectionOneState createState() => _SubjectSelectionOneState();
}

class _SubjectSelectionOneState extends State<SubjectSelectionOne> {
