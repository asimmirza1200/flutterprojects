...
class SubjectSelectionSeven extends StatefulWidget {
  final Color themeColor;
  final Color leftPatternColor;
  final Color leftTextColor;
  final Map arguments;
  SubjectSelectionSeven({
    this.themeColor,
  ...
  @override
  _SubjectSelectionSevenState createState() => _SubjectSelectionSevenState();
}

class _SubjectSelectionSevenState extends State<SubjectSelectionSeven> {
